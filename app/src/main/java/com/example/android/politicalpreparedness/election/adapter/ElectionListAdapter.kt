...
class ElectionListAdapter(private val listener: OnElectionListener) : ListAdapter<Election, ElectionViewHolder>(ElectionDiffCallback()) {
...
class OnElectionListener(val listener: (election: Election) -> Unit) {
